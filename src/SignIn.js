...
function SignIn(){
  ...
  useEffect(()=>{
   ...
   const navigate = useNavigate();
    const [loguser,setLogUser] = useState({
      ...
      const formStyle = {
        backgroundImage: "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZC8SYxf2tFlBemf-Jbo3AhFIdR2wl6X60iQ&s')",
  ...
  <div>
  <label style={{color:"black"}} htmlFor="email" class="form-label">Email :</label>
    <input type="text" 
  ...
  <div className="mb-3">
    <label style={{color:"black"}} htmlFor="pass" className="form-label">Password :</label>
    <input type="text" 
    class="form-control" 
    id="pass"
